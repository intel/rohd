...
abstract class Module {
  ...
  Future<void> build() async {
    ...
    ModuleTree.instance.rootModule = this;
  }
  ...
  /// Generates SystemVerilog for this [Module].
  ///
  /// Optionally writes the generated output to [outputPath].
  ///
  /// When [multiFile] is `true`, [outputPath] is a directory and each module
  /// definition is written to its own `.sv` file. Otherwise, [outputPath] is
  /// the path to one concatenated SystemVerilog file.
  ///
  ...
  /// Attaches VCD waveform dumping for this [Module] to [outputPath].
  ///
  ...
  @Deprecated('Use Module.dumpSystemVerilog(configuration: ...).output for '
      ...
      'configuration: ...) for direct file output, or '
      'SystemVerilogService for advanced options.')
