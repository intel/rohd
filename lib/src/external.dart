...
abstract class ExternalModule extends Module with CustomSystemVerilog {
  ...
  ExternalModule(this.topModuleName, {this.parameters, String name='external_module'}) : super(name: name);
  ...
  String instantiationVerilog(String instanceType, String instanceName, Map<String,String> inputs, Map<String,String> outputs) {
    ...
    return SystemVerilogSynthesizer.instantiationVerilogWithParameters(this, topModuleName, instanceName, inputs, outputs, parameters: parameters);
  }
}
