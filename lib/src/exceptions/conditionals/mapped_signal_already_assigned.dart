...
//
// mapped_signal_already_assigned.dart
...
/// multiple times.
class MappedSignalAlreadyAssigned extends RohdException {
  /// Creates a [MappedSignalAlreadyAssigned] for [signalName].
  MappedSignalAlreadyAssigned(
    String signalName,
