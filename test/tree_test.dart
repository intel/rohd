...
void main() {
  ...
  group('simcompare', () {
    test('tree', () async {
      ...
      var vectors = [
        Vector({ for (var i in List<int>.generate(16, (index) => index)) 'seq$i' : i }, {'out': 15}),
      ];
      await SimCompare.checkFunctionalVector(mod, vectors);
      var simResult = SimCompare.iverilogVector(mod.generateSynth(), mod.runtimeType.toString()+'_3', vectors,
        signalToWidthMap: {
