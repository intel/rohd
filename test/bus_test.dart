...
void main() {
  ...
  group('functional', () {
    test('NotGate bus', () async {
      ...
      var out = gtm.aBar;
      await gtm.build();
      a.put(0xff); expect(out.valueInt, equals(0));
      a.put(0); expect(out.valueInt, equals(0xff));
      a.put(0x55); expect(out.valueInt, equals(0xaa));
      a.put(0x1); expect(out.valueInt, equals(0xfe));
    });
    ...
    test('And2Gate bus', () async {
      ...
      a.put(0xff); b.put(0xaa); expect(out.valueInt, equals(0xaa));
    });
    ...
    test('Bus shrink', () async {
      ...
      var out = gtm.aShrunk;
      await gtm.build();
      a.put(0); expect(out.valueInt, equals(0));
      a.put(0xff); expect(out.valueInt, equals(bin('111')));
      a.put(0xf5); expect(out.valueInt, equals(5));
    });
    ...
    test('Bus swizzle', () async {
      ...
      await gtm.build();
      a.put(0); b.put(0); expect(out.valueInt, equals(0));
      a.put(0xff); b.put(0xff); expect(out.valueInt, equals(0xffff));
      a.put(0xff); b.put(0); expect(out.valueInt, equals(0xff));
      a.put(0); b.put(0xff); expect(out.valueInt, equals(0xff00));
      a.put(0xaa); b.put(0x55); expect(out.valueInt, equals(0x55aa));
    });
