...
class DevtoolAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const DevtoolAppBar({super.key, this.hasColorEmoji = kIsWeb});
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
        ...
        leading: Padding(
            ...
            child:
                Image.asset('assets/icons/rohd_logo.png', fit: BoxFit.contain)),
        actions: <Widget>[
          // ── Help ──
          ...
          BlocBuilder<DevToolsThemeCubit, DevToolsThemeMode>(
            ...
            return IconButton(
                ...
                icon: platformIcon(isDark ? Icons.light_mode : Icons.dark_mode,
                    isDark ? '☀️' : '🌙',
                    size: 24,
                    color: accentColor,
