...
void main({bool noPrint=false}) async {
  ...
  Simulator.registerAction(100, () { if(!noPrint) print('Simulation completed!'); });
  ...
  if(!noPrint) print('To view waves, check out waves.vcd with a waveform viewer (e.g. `gtkwave waves.vcd`).');
}